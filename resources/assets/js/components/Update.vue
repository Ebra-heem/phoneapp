	...
	<div class="modal" :class='openmodal'>
	  ...
	  <div class="modal-card">
	    ...
	    <section class="modal-card-body">
			<div class="field">
			  <label class="label">Name<span v-if="errors.name" class="has-text-danger">*</span></label>
			  <div class="control">
			...
			<div class="field">
			  <label class="label">Phone<span v-if="errors.phone" class="has-text-danger">*</span></label>
			  <div class="control">
			...
			<div class="field">
			  <label class="label">Email<span v-if="errors.email" class="has-text-danger">*</span></label>
			  <div class="control">
